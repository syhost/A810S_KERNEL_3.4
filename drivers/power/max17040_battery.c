...
//pz1946 20111028 booting condition change
...
#if defined(CONFIG_MACH_MSM8X60_EF40K) || defined(CONFIG_MACH_MSM8X60_EF40S)
...
#endif
//pz1946 20120106 compensation change
#ifdef CONFIG_SKY_SMB_CHARGER
int charging_stop_control = 0;
#if defined(CONFIG_MACH_MSM8X60_EF39S)
#define ONLINE_MAX_ADJUST_SOC	117100 
#define MAX_REAL_SOC_HIGH		116100 
#else
#define ONLINE_MAX_ADJUST_SOC	117400
#define MAX_REAL_SOC_HIGH		116100 
#endif
#endif
...
//pz1946 20111219 market 27223 debugging 
#if defined (CONFIG_MACH_MSM8X60_EF39S)
...
//pz1946 20111018 rcomp chagne condition
#if defined(CONFIG_MACH_MSM8X60_EF39S)
	/* rcomp_mode_set */
	int set_rcomp_mode;
#endif
...
//CONFIG_SKY_SMB_CHARGER: ef39s
//CONFIG_SKY_CHARGING: presto
extern unsigned long tzTemp;
#endif
...
//pz1946 20111021 EF40K EF40S common
...
//pz1946 20111028 booting cut off condition change
	if(init_count == 0 && (smb_charger_state == CHG_TYPE_NONE)) {
//pz1946 20111017 default vcell 3550=3.7V -> vcell 3450 = 3.65V 
#if defined(CONFIG_MACH_MSM8X60_EF39S)
		if( max17040_data.vcell <= 3530) {
#else
	if( max17040_data.vcell <= 3500) {
#endif
		initial_booting = 1;
		}
	}
...
static void max17040_get_soc(void)
{
	...
	int avalue=0;
	int soc=0;
//pz1946 20120106 compensation charging
#if defined(CONFIG_MACH_MSM8X60_EF39S) || defined(CONFIG_MACH_MSM8X60_EF40S) || defined(CONFIG_MACH_MSM8X60_EF40K)
	int real_soc = 0;
#endif
...
//pz1946 20120106 compensation charging
	...
	//Ajdusted soc%=(SOC%-EMPTY)/(FULL-EMPTY)*100
#if defined(CONFIG_MACH_MSM8X60_EF39S)
	if(avalue>3300) //pz1946 20111007 empty level change default avalue : 1200-> 900 -> 5200-> 3300
#else
	if(avalue>900) //pz1946 20111007 empty level change default avalue : 1200-> 900 -> 5200->900
#endif
...
//pz1946 20120106 compensation charging 
#if defined(CONFIG_MACH_MSM8X60_EF39S)  || defined(CONFIG_MACH_MSM8X60_EF40K) || defined(CONFIG_MACH_MSM8X60_EF40S) 
		pr_info("jcpark soc =%d smb_charger_state =%d charging_stop_control = %d real_soc =%d \n", soc, smb_charger_state, charging_stop_control, real_soc);

	if(real_soc >= ONLINE_MAX_ADJUST_SOC)
		charging_stop_control = 1;

	else if(real_soc < MAX_REAL_SOC_HIGH)
		charging_stop_control = 0;
#endif
#endif /* MAX17040_DEBUG_QUICK */	
...
//       pmic8058_tz_get_temp_charging(&pm_temp);
    	if(tzTemp>=0 && tzTemp<80000)
            pm_temp = tzTemp;
    	else
            pm_temp = 35000;

	//pr_info("~~~~pz1946 pm_temp = %ld\n", pm_temp);
...
#endif /* pz1946 20111219 market 27223 */
}
